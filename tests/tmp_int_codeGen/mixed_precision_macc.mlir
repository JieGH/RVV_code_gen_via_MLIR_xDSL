builtin.module {
  func.func @xdsl_api_gemm_RVV_8x8_i8i8i32_b0(%0 : index, %1 : !emitc.ptr<i8>, %2 : index, %3 : !emitc.ptr<i8>, %4 : index, %5 : !emitc.ptr<i32>, %6 : index) {
    ...
    %13 = emitc.call_opaque "__riscv_vsetvl_e8mf4"(%9) : (index) -> index
    ...
    %22 = emitc.call_opaque "__riscv_vmv_v_x_i32m1"(%12, %13) : (i32, index) -> !emitc.opaque<"vint32m1_t">
    %23 = emitc.call_opaque "__riscv_vmv_v_x_i32m1"(%12, %13) : (i32, index) -> !emitc.opaque<"vint32m1_t">
    %24 = emitc.call_opaque "__riscv_vmv_v_x_i32m1"(%12, %13) : (i32, index) -> !emitc.opaque<"vint32m1_t">
    %25 = emitc.call_opaque "__riscv_vmv_v_x_i32m1"(%12, %13) : (i32, index) -> !emitc.opaque<"vint32m1_t">
    %26 = emitc.call_opaque "__riscv_vmv_v_x_i32m1"(%12, %13) : (i32, index) -> !emitc.opaque<"vint32m1_t">
    %27 = emitc.call_opaque "__riscv_vmv_v_x_i32m1"(%12, %13) : (i32, index) -> !emitc.opaque<"vint32m1_t">
    %28 = emitc.call_opaque "__riscv_vmv_v_x_i32m1"(%12, %13) : (i32, index) -> !emitc.opaque<"vint32m1_t">
    %29 = emitc.call_opaque "__riscv_vmv_v_x_i32m1"(%12, %13) : (i32, index) -> !emitc.opaque<"vint32m1_t">
    %30 = emitc.call_opaque "__riscv_vmv_v_x_i16mf2"(%11, %13) : (i16, index) -> !emitc.opaque<"vint16mf2_t">
    ...
    ^bb0(%41 : index):
      ...
      %45 = emitc.call_opaque "__riscv_vle8_v_i8mf4"(%44, %13) : (!emitc.ptr<i8>, index) -> !emitc.opaque<"vint8mf4_t">
      ...
      %50 = emitc.call_opaque "__riscv_vwmacc_vx_i16mf2"(%30, %49, %45, %13) : (!emitc.opaque<"vint16mf2_t">, i8, !emitc.opaque<"vint8mf4_t">, index) -> !emitc.opaque<"vint16mf2_t">
      %51 = "emitc.load"(%31) : (!emitc.lvalue<!emitc.opaque<"vint32m1_t">>) -> !emitc.opaque<"vint32m1_t">
      %52 = emitc.call_opaque "__riscv_vwadd_wv_i32m1"(%51, %50, %13) : (!emitc.opaque<"vint32m1_t">, !emitc.opaque<"vint16mf2_t">, index) -> !emitc.opaque<"vint32m1_t">
      ...
      %56 = emitc.call_opaque "__riscv_vwmacc_vx_i16mf2"(%30, %55, %45, %13) : (!emitc.opaque<"vint16mf2_t">, i8, !emitc.opaque<"vint8mf4_t">, index) -> !emitc.opaque<"vint16mf2_t">
      %57 = "emitc.load"(%32) : (!emitc.lvalue<!emitc.opaque<"vint32m1_t">>) -> !emitc.opaque<"vint32m1_t">
      %58 = emitc.call_opaque "__riscv_vwadd_wv_i32m1"(%57, %56, %13) : (!emitc.opaque<"vint32m1_t">, !emitc.opaque<"vint16mf2_t">, index) -> !emitc.opaque<"vint32m1_t">
      ...
      %62 = emitc.call_opaque "__riscv_vwmacc_vx_i16mf2"(%30, %61, %45, %13) : (!emitc.opaque<"vint16mf2_t">, i8, !emitc.opaque<"vint8mf4_t">, index) -> !emitc.opaque<"vint16mf2_t">
      %63 = "emitc.load"(%33) : (!emitc.lvalue<!emitc.opaque<"vint32m1_t">>) -> !emitc.opaque<"vint32m1_t">
      %64 = emitc.call_opaque "__riscv_vwadd_wv_i32m1"(%63, %62, %13) : (!emitc.opaque<"vint32m1_t">, !emitc.opaque<"vint16mf2_t">, index) -> !emitc.opaque<"vint32m1_t">
      ...
      %68 = emitc.call_opaque "__riscv_vwmacc_vx_i16mf2"(%30, %67, %45, %13) : (!emitc.opaque<"vint16mf2_t">, i8, !emitc.opaque<"vint8mf4_t">, index) -> !emitc.opaque<"vint16mf2_t">
      %69 = "emitc.load"(%34) : (!emitc.lvalue<!emitc.opaque<"vint32m1_t">>) -> !emitc.opaque<"vint32m1_t">
      %70 = emitc.call_opaque "__riscv_vwadd_wv_i32m1"(%69, %68, %13) : (!emitc.opaque<"vint32m1_t">, !emitc.opaque<"vint16mf2_t">, index) -> !emitc.opaque<"vint32m1_t">
      ...
      %74 = emitc.call_opaque "__riscv_vwmacc_vx_i16mf2"(%30, %73, %45, %13) : (!emitc.opaque<"vint16mf2_t">, i8, !emitc.opaque<"vint8mf4_t">, index) -> !emitc.opaque<"vint16mf2_t">
      %75 = "emitc.load"(%35) : (!emitc.lvalue<!emitc.opaque<"vint32m1_t">>) -> !emitc.opaque<"vint32m1_t">
      %76 = emitc.call_opaque "__riscv_vwadd_wv_i32m1"(%75, %74, %13) : (!emitc.opaque<"vint32m1_t">, !emitc.opaque<"vint16mf2_t">, index) -> !emitc.opaque<"vint32m1_t">
      ...
      %80 = emitc.call_opaque "__riscv_vwmacc_vx_i16mf2"(%30, %79, %45, %13) : (!emitc.opaque<"vint16mf2_t">, i8, !emitc.opaque<"vint8mf4_t">, index) -> !emitc.opaque<"vint16mf2_t">
      %81 = "emitc.load"(%36) : (!emitc.lvalue<!emitc.opaque<"vint32m1_t">>) -> !emitc.opaque<"vint32m1_t">
      %82 = emitc.call_opaque "__riscv_vwadd_wv_i32m1"(%81, %80, %13) : (!emitc.opaque<"vint32m1_t">, !emitc.opaque<"vint16mf2_t">, index) -> !emitc.opaque<"vint32m1_t">
      ...
      %86 = emitc.call_opaque "__riscv_vwmacc_vx_i16mf2"(%30, %85, %45, %13) : (!emitc.opaque<"vint16mf2_t">, i8, !emitc.opaque<"vint8mf4_t">, index) -> !emitc.opaque<"vint16mf2_t">
      %87 = "emitc.load"(%37) : (!emitc.lvalue<!emitc.opaque<"vint32m1_t">>) -> !emitc.opaque<"vint32m1_t">
      %88 = emitc.call_opaque "__riscv_vwadd_wv_i32m1"(%87, %86, %13) : (!emitc.opaque<"vint32m1_t">, !emitc.opaque<"vint16mf2_t">, index) -> !emitc.opaque<"vint32m1_t">
      ...
      %92 = emitc.call_opaque "__riscv_vwmacc_vx_i16mf2"(%30, %91, %45, %13) : (!emitc.opaque<"vint16mf2_t">, i8, !emitc.opaque<"vint8mf4_t">, index) -> !emitc.opaque<"vint16mf2_t">
      %93 = "emitc.load"(%38) : (!emitc.lvalue<!emitc.opaque<"vint32m1_t">>) -> !emitc.opaque<"vint32m1_t">
      %94 = emitc.call_opaque "__riscv_vwadd_wv_i32m1"(%93, %92, %13) : (!emitc.opaque<"vint32m1_t">, !emitc.opaque<"vint16mf2_t">, index) -> !emitc.opaque<"vint32m1_t">
    ...
    emitc.call_opaque "__riscv_vse32_v_i32m1"(%109, %97, %13) : (!emitc.ptr<i32>, !emitc.opaque<"vint32m1_t">, index) -> ()
    ...
    emitc.call_opaque "__riscv_vse32_v_i32m1"(%112, %98, %13) : (!emitc.ptr<i32>, !emitc.opaque<"vint32m1_t">, index) -> ()
    ...
    emitc.call_opaque "__riscv_vse32_v_i32m1"(%115, %99, %13) : (!emitc.ptr<i32>, !emitc.opaque<"vint32m1_t">, index) -> ()
    ...
    emitc.call_opaque "__riscv_vse32_v_i32m1"(%118, %100, %13) : (!emitc.ptr<i32>, !emitc.opaque<"vint32m1_t">, index) -> ()
    ...
    emitc.call_opaque "__riscv_vse32_v_i32m1"(%121, %101, %13) : (!emitc.ptr<i32>, !emitc.opaque<"vint32m1_t">, index) -> ()
    ...
    emitc.call_opaque "__riscv_vse32_v_i32m1"(%124, %102, %13) : (!emitc.ptr<i32>, !emitc.opaque<"vint32m1_t">, index) -> ()
    ...
    emitc.call_opaque "__riscv_vse32_v_i32m1"(%127, %103, %13) : (!emitc.ptr<i32>, !emitc.opaque<"vint32m1_t">, index) -> ()
    ...
    emitc.call_opaque "__riscv_vse32_v_i32m1"(%130, %104, %13) : (!emitc.ptr<i32>, !emitc.opaque<"vint32m1_t">, index) -> ()
    func.return
  }
}